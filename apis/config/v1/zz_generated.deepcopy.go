...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestPlugin1Args) DeepCopyInto(out *TestPlugin1Args) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.LabelKey != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestPlugin1Args.
func (in *TestPlugin1Args) DeepCopy() *TestPlugin1Args {
	if in == nil {
		return nil
	}
	out := new(TestPlugin1Args)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TestPlugin1Args) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
